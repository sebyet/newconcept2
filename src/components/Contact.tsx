        ...
        <div className='container mx-auto px-4'>
          <div className='flex flex-wrap -mx-4'>
            <div className='w-full lg:w-1/2 px-4 order-last lg:order-first'>
              <img
                className='block max-w-lg mx-auto lg:max-w-none h-full w-full rounded-2xl object-cover'
                src={footer.src}
                alt=''
              />
            </div>
            <div className='w-full lg:w-1/2 px-4'>
              <div className='max-w-lg mx-auto lg:mr-0 pt-14 pb-16 lg:py-24'>
                ...
                <div className='sm:flex mb-10'>
                  <div className='flex h-12 w-12 items-center justify-center border border-coolGray-800 rounded-2xl text-white'>
                    <svg
                      width={24}
                      height={24}
                      viewBox='0 0 24 24'
                  ...
                  <div className='mt-6 sm:mt-0 sm:ml-6'>
                    <span className='block text-white text-lg font-medium mb-1'>
                      {t('contact.chat')}
                    </span>
